...
<template>
  <div class="container">
      ...
      <table>
        ...
        <tbody>
          <tr v-for="(store, index) in stores" :key="`store-${index}`">
            <td>{{ store.name }}</td>
            <td>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="actions edit" @click="editStore(store)">
    ...
    <Modal :open.sync="open" @hide="resetForm" width="25rem" height="25vh">
      ...
      <template v-slot:footer>
        <div class="footer-modal">
          ...
          <button class="success" @click="actionModal == 'add' ? save() : update()">
