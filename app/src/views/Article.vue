    ...
    <div class="table">
      <div class="filters">
        <button
          ...
          data-bs-target="#modal_principal"
          @click="addArticle"
        >
          Add Article
        </button>
    ...
    <Modal>
      ...
      <template v-slot:body>
        <div class="container-modal">
          <div>
            <label for="">Name:</label> <input type="text" v-model="name" class="form-control p-3" />
          </div>
          <div>
            <label for="">Price:</label>
            <input type="number" v-model="precio" class="form-control p-3"/>
          </div>
          <div>
            <label for="">Store:</label>
            <select v-model="storeId" class="form-control">
      ...
      <template v-slot:footer>
        <div class="footer-modal">
          <button class="danger" data-bs-dismiss="modal" @click="resetForm">
            Cancel
          </button>
          <button
            class="success"
